...
<?php $__env->startSection('content'); ?>
    ...
    <section class="hero" id="hero">
        ...
        <!-- Local images -->
        <div class="hero-slide" style="background-image: url('<?php echo e(asset('assets/img/hero_1.png')); ?>');"></div>
        <div class="hero-slide" style="background-image: url('<?php echo e(asset('assets/img/hero_2.png')); ?>');"></div>
        <div class="hero-slide" style="background-image: url('<?php echo e(asset('assets/img/hero_3.png')); ?>');"></div>
        <div class="hero-slide" style="background-image: url('<?php echo e(asset('assets/img/hero_4.png')); ?>');"></div>
        ...
        <div class="hero-content" data-aos="fade-up">
            ...
            <div class="hero-buttons">
                <a href="<?php echo e(route('quote')); ?>" class="btn">Get a Free Quote</a>
        ...
        <div class="container">
            ...
            <div class="services-grid">
                <div class="service-card" data-aos="fade-up" data-aos-delay="100">
                    ...
                    <a href="<?php echo e(route('quote')); ?>" class="btn">Get a Quote</a>
                </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp\htdocs\dashboard\tms_db\tms_db\resources\views/home.blade.php ENDPATH**/ ?>